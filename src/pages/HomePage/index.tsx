...
import myPicture from "../../assets/pictures/WhatsApp Image 2025-07-03 at 07.42.25_bf885a40.jpg";

const links = [
    { platform: "LinkedIn", url: "https://www.linkedin.com/in/sahan-dhanujaya-040aa4359/", icon: <FaLinkedin /> },
    { platform: "GitHub", url: "https://github.com/SahanDhanujaya", icon: <FaGithub /> },
    { platform: "Twitter", url: "https://twitter.com/dhanux", icon: <FaX /> },
    { platform: "Instagram", url: "https://www.instagram.com/dhanux", icon: <FaInstagram /> },
]
        ...
        <div className="flex space-x-4 ml-auto text-[1rem] items-center">
            {
                links.map((link, index) => (
                    <a key={index} className="" href={link.url} target="_blank" rel="noopener noreferrer">
                        {link.icon}
                    </a>
                ))
            }
